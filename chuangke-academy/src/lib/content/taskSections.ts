...
// stepOrdinal / isFieldActive live in ./fieldState.ts and are re-exported
// here for anything that already imports them from taskSections. That file
// has no "node:fs"/"node:path" imports, unlike this one — see its header
