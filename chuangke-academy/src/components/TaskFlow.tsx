...
type Props = { stage: Stage; courseKey: string; tasks: TaskWithFields[]; workspaceId?: string };
...
export default function TaskFlow({ stage, courseKey, tasks, workspaceId }: Props) {
